...
const MessageBlock = ({ message, isLoading = false }: {message: Message, isLoading?: boolean}) => {
    return (
        <div className={
            cn("text-white, bg-background-chat px-4 py-8 w-full flex justify-center",
            ...
            <div className="w-full max-w-[833px] flex">
                ...
                {isLoading ? (
                    <Image
                        ...
                        width={36}
                        height={36}
                        alt="Animação de carregamento (Loaging)"
                        color="mr-4"
                    />
                ) : (message.role)}
            </div>
